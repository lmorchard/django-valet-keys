...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('valet_keys_keyaction', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('key', self.gf('django.db.models.fields.related.ForeignKey')(related_name='history', to=orm['valet_keys.Key'])),
        ...
        db.send_create_signal('valet_keys', ['KeyAction'])


    def backwards(self, orm):
        
        # Deleting model 'KeyAction'
        db.delete_table('valet_keys_keyaction')
    ...
    models = {
        ...
        'valet_keys.keyaction': {
            'Meta': {'object_name': 'KeyAction'},
            'action': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'history'", 'to': "orm['valet_keys.Key']"}),
